...
from src.datasets.dreambooth_inpaint_dataset import DreamBoothDataset, tokenize_prompt, PromptDataset
...
class Trainer:
    ...
    def __init_dataset__(self):
        self.dataset = DreamBoothDataset(
            instance_data_dir=self.args.instance_data_dir,
    ...
    def train_epoch(self):
        ...
        for step, batch in enumerate(self.dataloader):
            ...
            bzs, channels, height, width = model_input.shape
