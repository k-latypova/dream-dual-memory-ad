...
def parse_args(input_args=None):
    ...
    return args
"""
accelerate launch scripts/train_dreambooth_inpaint_hf.py \
    --pretrained_model_name_or_path="sd-legacy/stable-diffusion-inpainting" \
    --instance_data_dir=/scratch/latypova/data/mvtec/capsule/train/good \
    --class_data_dir=/scratch/latypova/data/dreambooth/inpaint/capsule/class_samples \
    --class_prompt="a high quality photo of a pharmaceutical capsule" \
    --instance_prompt="a photo of a sks capsule" \
    --n_save_sample=10 \
    --with_prior_preservation --prior_loss_weight=0.7 --num_class_images=100 \
    --output_dir=/scratch/latypova/dreambooth/inpaint/capsule/model \
    --resolution=512 --center_crop --train_text_encoder \
    --train_batch_size=4 --sample_batch_size=4 --num_train_epochs=1 \
    --max_train_steps=400 --lr_warmup_steps=0 --not_cache_latents
"""
...
def main(args):
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.train_batch_size, shuffle=True, collate_fn=collate_fn, pin_memory=True, num_workers=args.num_workers
    )
    ...
    def save_weights(step):
        ...
        if accelerator.is_main_process:
            ...
            pipeline = StableDiffusionInpaintPipeline(
                ...
                safety_checker=None,
                scheduler=scheduler,
                feature_extractor=init_pipeline.feature_extractor,
                tokenizer=init_pipeline.tokenizer,
            )
